...
import 'package:nurse_enroll/views/new_profile_form.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final NurseProfileFormManager _formManager = NurseProfileFormManager();
    ...
    return Scaffold(
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ProfileForm(formKey: _formKey, formManager: _formManager),
